...
export class LocalServer {
	...
	private serverConfig: Configuration.ServerConfiguration;
	constructor(buildFolder: string) {
		this.serverConfig = Configuration.ServerConfiguration.getServerConfig();
		...
		Configuration.ServerConfiguration.getServerConfig().getRepos().forEach(repo => {
